...
const Education = () => {
    ...
    degrees: [
      {
        ...
        year: "2019 - 2023",
        description: "Graduated with honors. Specialized in business studies while actively learning full-stack web development and building projects.",
        icon: <FaUniversity />,
        score: "CGPA: 3.08/4.0"
      },
      {
        ...
        year: "2017 - 2019",
        description: "Focused on accounting and business principles while exploring programming fundamentals.",
        icon: <FaMedal />,
        score: "GPA: 3.83/5.0"
      },
       {
        ...
        year: "2014 - 2016",
        description: "Specialized in Physics and Mathematics. Achieved top 1% in national science olympiad.",
        icon: <FaMedal />,
        score: "GPA: 4.0/4.0"
      }
    ],
 ...
 const gpaData = {
  ...
  return (
    <section className="relative py-16 px-4 md:px-8 min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 overflow-hidden">
      ...
      <div className="w-10/12 mx-auto relative z-10">
          ...
          <motion.div 
                              ...
                              >
                                <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
                                  Education <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-cyan-400">Qualifications</span>
                                </h2>
        ...
        >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
          >
            <FaTrophy />Course Certifications
          </motion.button>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          >
            ...
            <div className="relative">
              ...
              <div className="space-y-10">
                {(activeTab === 'degrees' ? educationData.degrees : educationData.certifications).map((item, index) => (
                  <motion.div 
                    key={item.id}
                      ...
                      <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-6 border border-white/10 shadow-xl transition-all duration-300 hover:border-cyan-400/30">
                        <div className="flex justify-between flex-wrap gap-2">
                          <div>
                            ...
                            <h3 className="text-xl md:text-2xl font-bold text-white">{activeTab === 'degrees' ? item.degree : item.name}</h3>
                            <div className="flex items-center gap-2 mt-1 mb-3 text-cyan-200">
                              <FaUniversity />
                              <p className="font-medium">{item.institution || item.issuer}</p>
                            </div>
                          </div>
          ...
          >
            <div className="mb-6">
              <h3 className="text-xl font-bold text-white mb-2">Academic Performance</h3>
              <p className="text-cyan-200 text-sm">GPA progression throughout my academic journey</p>
            </div>
