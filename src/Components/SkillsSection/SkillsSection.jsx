...
const SkillsSection = () => {
  ...
  useEffect(() => {
    const createFloatingElement = () => {
      ...
      element.className = `absolute rounded-full bg-gradient-to-br ${
  ...
  return (
    <section
      id="skills"
      className="py-16 relative overflow-hidden skills-container bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
        ...
        <div className="relative z-10">
          ...
          <div className="text-center mb-16">
            ...
            <motion.p
              ...
              A showcase of my technical skills with interactive animations and
            ...
            {categories.map((category, index) => (
              <motion.div
                ...
                <div className="flex items-center mb-6">
                  <div
                    className={`w-12 h-12 rounded-full bg-gradient-to-br ${category.color} flex items-center justify-center mr-4`}>
